    ...
    <div  style="margin: 15%; margin-top: 5%; margin-bottom: 5%;background: rgb(255,255,255);padding: 5%; padding-left: 7%; border-radius: 20px;border-style: solid;border-color: rgb(241, 247, 252);">
        ...
        <form style="padding: 25px;" name="myForm" id="myForm" onsubmit="return ifEmpty()" method="POST" action="server/form.php">
            ...
            <div  class="form-group" style="padding-left: 35px;color: rgb(80, 94, 108); font-size: 19px; margin-bottom: 10px;">
                ...
                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-8" name="pregunta2" value="De 31 a 35 años"><label class="form-check-label" for="formCheck-8">De 31 a 35 años</label></div>
